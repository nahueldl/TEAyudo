import { IonActionSheet, IonAlert, IonButton, IonContent, IonGrid, IonInput, IonItem, IonLabel, IonList, IonLoading, IonRow, IonTitle, NavContext } from "@ionic/react";
...
const ViewEditDeleteCategory = () => {
    ...
    const [ nombreCategoriaAux, setNombreCategoriaAux] = useState<string>(categoriaData.categoriaSelected?.nombre!);
...
return (
    <Page pageTitle={`Categoria ${categoriaData.categoriaSelected?.nombre}`} showHomeButton>
        <IonContent>
